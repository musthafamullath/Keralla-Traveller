...
import 'package:foodie_fly/view/screen/cart/widgets/shimmer_widget.dart';
    ...
    return Scaffold(
      ...
      body: BlocBuilder<CartBloc, CartState>(
        builder: (context, state) {
          ...
          } else if (state is GetAllCartItemsState) {
                                    ...
                                    : ListView.separated(
                                        ...
                                        itemBuilder: (context, index) {
                                          sellerId = state
                                              ...
                                              ? state.cartItems[index].sellerId
                                              : 0;
                                          return SizedBox(
                                            height: height * .065,
                                            child: Row(
                                                                        ...
                                                                        value <
                                                                            state
                                                                                .cartItems[
                                                                                    index]
                                                                                .quantity
                                                                    ? context.read<CartBloc>().add(DecreaseCartEvent(
                                                                        dishId: state
                                                                            .cartItems[
                                                                                index]
                                                                            .dishId,
          ...
          return const Padding(
            ...
            child: Center(child: Column(
              children: [
                SpinKitCircle(color: yellowGreen,),
                Text("Pls Wait",style: semiBoldBlack,)
              ],
            ),),
          );
        },
